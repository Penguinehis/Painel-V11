                ...
                <div class="card-body">
                    <form action="validacao.php" method="post">
                        <form class="form-horizontal form-../material" id="loginform" action="home.php">
                            <center><h3><i class="fab fa-linux"></i> SSH<b>PLUS</b></h3></center>
                            <div class="form-group ">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                    <div class="social">
                                        <a href="../index.php" class="btn btn-circle btn-warning" data-toggle="tooltip" title="Area do Usúario"> <i aria-hidden="true" class="fas fa-user"></i></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            ...
                            Todos Direitos Reservados <a href="https://t.me/crazy_vpn" class="text-info m-l-5"><b>SSHPLUS</b></a></p>
                        </div>
                    </div>
