		...
		<div class="col-lg-4 col-xlg-3 col-md-5">
			...
			<div class="card">
				<div class="card-body">
					...
					<center><a onclick="excluir_usuario()" class="btn btn-danger"><b><font color="white">DELETAR TUDO</font></b></a></center><br>
					...
					<?php }?>
					<center><a href="../pages/system/funcoes.usuario.php?&id_usuario=<?php echo $usuario['id_usuario'];?>&diretorio=../../admin/home.php?page=usuario/listar&owner=<?php echo $accessKEY;?>&op=senha" class="btn btn-primary btn-primary"><b>REENVIAR SENHA</b></a></center><br>
					<center><a href="?page=usuario/addservidor" class="btn btn-primary btn-success"><b>ADICIONAR SERVIDOR</b></a></center>
				</div>
				<!-- /.box-body -->
			</div>
			<!-- /.box -->
