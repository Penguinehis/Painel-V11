            ...
            <div class="box box-primary">
              ...
              <?php if($servidor_autenticado){?>
                <ul class="list-group list-group-unbordered">
                  ...
                  <li class="list-group-item">
                    <b>Memoria total</b> <a class="pull-right"><?php echo $words[7]; ?> Mb</a>
                  </li>
                  <li class="list-group-item">
                    <b>Memoria usada</b> <a class="pull-right"><?php echo $words[8]; ?> Mb</a>
                  </li>
                  <li class="list-group-item">
                    <b>Memoria livre</b> <a class="pull-right"><?php echo $words[9]; ?> Mb</a>
                  </li>
                  <li class="list-group-item">
                    <b>Memoria cache</b> <a class="pull-right"><?php echo $words[11]; ?> Mb</a>
                  </li>
                  <li class="list-group-item">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                  <center><h4 class="modal-title">Funções do servidor</h4></center>
                                </div>
            ...
            <div class="card-body p-b-0">
             ...
             <div class="tab-content">
              ...
              <button type="reset" class="btn btn-inverse">Limpar</button>
                ...
                <div class="card">
                 <div class="card-body">
                 <h4 class="card-title"><center>Outras Opções</center></h4><hr><br>
                <div class="button-group">                
                <center><a href="../admin/pages/servidor/servidor_exe.php?id_servidor=<?php echo $servidor['id_servidor'];?>&op=deletarGeral" class="btn btn-danger">Deletar Tudo</a>
                <a href="../admin/pages/servidor/servidor_exe.php?id_servidor=<?php echo $servidor['id_servidor'];?>&op=deletarContas" class="btn btn-danger">Deletar Contas SSH</a>
                 <?php if($servidor['manutencao']=='nao'){ ?>
                  <a href="../admin/pages/servidor/servidor_exe.php?id_servidor=<?php echo $servidor['id_servidor'];?>&op=manutencao" class="btn btn-warning">Por em Manutenção </a><br><br>
                <?php }else{ ?>
                  <a href="../admin/pages/servidor/servidor_exe.php?id_servidor=<?php echo $servidor['id_servidor'];?>&op=manutencao" class="btn btn-info">Tirar Manutenção</a><br><br>
                <?php } ?> </center>    
                </div>
                </div>
                </div>
                  ...
                  <form role="form" action="pages/servidor/enviar_ovpn.php" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="box-footer box-primary">
                      <div class="box-header with-border">
                        <?php if($SQLovpn->rowCount()==0){ ?> <button type="submit" class="btn btn-success">Enviar OVPN</button></form><?php } ?>
                        <a href="../admin/pages/servidor/deletar_ovpn.php?id_servidor=<?php echo $servidor['id_servidor'];?>" class="btn btn-inverse">Deletar OVPN</a>
                      </div>
                    </div>
                  </div>
                </div>
