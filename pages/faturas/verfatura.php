				...
				<div class="row">
                    <div class="col-md-12">
                        <div class="card card-body printableArea">
                            <h3><b>MundoSSH, Inc.</b>Fatura N°#<?php echo $fatu['id']; ?> Data: <?php echo $dia;?>/<?php echo $mes;?>/<?php echo $ano;?> </h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left">
                                        <address>
                                            <h3> &nbsp;<b class="text-danger">MundoSSH, Inc.</b></h3>
                                            <p class="text-muted m-l-5">Cabreuva, SP
                                                <br/> Telefone: (11) 97343-2912
                                                <br/> Email: o.souzanavarro@gmail.com
                                                <br/> Telegram: @souzanavarro</p>
												<br/> (Aceitamos Depósito e Transfêrencia• Bancaria)</p>
												<br/> •Conta: 000000 •Agencia: 0000 •Nome: Orlando Souza (Após o pagamento enviar a confirmação com a print do comprovante.)</p>
                                        </address>
                                    </div>
                                    <div class="pull-right text-right">
                                        <address>
                                            ...
                                            <p class="m-t-30"><b>Fatura #</b> <i class="fa fa-calendar"></i> <?php echo $fatu['id']; ?></p></p>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <p>Subtotal: R$<?php echo $total2;?></p>
                                        <p>Taxas: R$00,00</p>
