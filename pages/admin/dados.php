    ...
    <div class="container-fluid">
      ...
      <?php if($usuario['atualiza_dados']==0){?>
        <div class="alert alert-warning">
          ...
          <center><h3><i class="fas fa-user-tie" ></i> Primeiro acesso </h3> Para continuar, preencha todos os campos e salve!</center>
        </div>
      <?php }?>
      ...
      <style>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body" id="container">
                <div id="box-" class="box"><img onclick="selecionachar(1);" style="width:100%;max-width:100px" class="profile-user-img img-responsive img-circle"  src="../../dist/img/avatar1.png" alt="User profile picture"></div>
                <div id="box-" class="box"><img onclick="selecionachar(2);" style="width:100%;max-width:100px" class="profile-user-img img-responsive img-circle"  src="../../dist/img/avatar2.png" alt="User profile picture"></div>
                <div id="box-" class="box"><img onclick="selecionachar(3);" style="width:100%;max-width:100px" class="profile-user-img img-responsive img-circle"  src="../../dist/img/avatar3.png" alt="User profile picture"></div>
                <div id="box-" class="box"><img onclick="selecionachar(4);" style="width:100%;max-width:100px" class="profile-user-img img-responsive img-circle"  src="../../dist/img/avatar4.png" alt="User profile picture"></div>
                <div id="box-" class="box"><img onclick="selecionachar(5);" style="width:100%;max-width:100px" class="profile-user-img img-responsive img-circle" src="dist/img/avatar5.png" alt="User profile picture"></div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-xlg-3 col-md-5">
            <!-- Profile Image -->
            <div class="card">
              <img class="card-img-top" src="../assets/images/background/fundo.jpg" alt="Card image cap">
              ...
              <div class="card-body p-b-0">
                ...
                <form  class="form-horizontal" role="form" id="form" name="form" action="pages/admin/alterar.php" method="post">
                  ...
                  <div class="form-actions">
                    <button type="submit" class="btn btn-success">Salvar Dados</button><br><br>
                  </div>
                </form>
              </div>
            </div>
