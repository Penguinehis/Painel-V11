            ...
            <div class="card-body">
                <form action="validacao.php" method="post">
                    <form class="form-horizontal form-material" id="loginform" action="home.php">
                        <center><h3><i class="fa fa-linux"></i> SSH<b>PLUS</b></h3></center>
                        <div class="form-group ">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                </div> <a data-toggle="modal" data-target="#myModal" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Esqueceu?</a>
                            </div>
                        </div>
